...
static int AssimpRenderer::printOglError(char *file,
																	int line)
{
	GLenum glErr;
	int    retCode = 0;
...
static void AssimpRenderer::crossProduct( float *a, float *b, float *res) {
...
// Normalize a vec3
static void AssimpRenderer::normalize(float *a) {
...
static void AssimpRenderer::setIdentityMatrix( float *mat,
																							 int size) {
	// fill matrix with 0s
...
static void AssimpRenderer::multMatrix(float *a,
																			 float *b) {
	float res[16];
...
static void AssimpRenderer::setTranslationMatrix(float *mat,
																								 float x,
																								 float y,
																								 float z) {
...
static void AssimpRenderer::setScaleMatrix(float *mat,
																					 float sx,
																					 float sy,
																					 float sz) {
...
static void AssimpRenderer::setRotationMatrix(float *mat, float angle, float x, float y, float z) {
